...
Create a new directory `content/tools/TOOLNAME/` with an `index.yaml` file. The directory
...
Put screenshot images in `content/tools/TOOLNAME/` alongside `index.yaml`.
